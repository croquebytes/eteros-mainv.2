...
## Phase 1.5 – Layout & Responsive UI (New)

**Date Completed:** 2025-12-02
**Goal:** Modernize window management and enable mobile playability.

### Features Implemented
*   **Advanced Snap Layouts:** Added "Primary + Side Stack" (1+2) layout to the window snap menu.
*   **Mobile UI Mode:**
    *   Automatic mobile detection (<768px).
    *   **Bottom Navigation Bar:** Replaces taskbar on mobile (Home, Quest, Shop, Apps).
    *   **Full-Screen Apps:** Windows automatically fill the available space on mobile.
*   **Text Polish:** Implemented smart truncation for desktop icons (2 lines) and window titles (1 line).
